...
export const formulaDiagnostico: CriterioFormula[] = [
  {
    ...
    itens: [
      ...
      },
      {
        ...
        status: 'temos',
        onde: '3 hipóteses formalizadas no formato "se X, então Y — medido por Z" (minuta neste dossiê) e MEDIDAS no sistema: SLA ≤10 min → conversão (Voz do Cliente: 22%→81% em ≤10 min, conversão 8,1%→13,9%); PDCA dos números; absorção no K2.',
        fazer: 'Abrir a apresentação da 2ª banca com as 3 hipóteses e provar cada uma com a tela que a mede.',
      },
    ],
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        status: 'temos',
        onde: '3 metas públicas declaradas: (1) carta ≥100% em setembro; (2) absorção 65% até dezembro (hoje 49,4%); (3) lead atendido em ≤10 min (hoje 81% dentro do SLA). Todas medidas ao vivo no sistema.',
        fazer: 'Repetir as 3 metas em todo material da 2ª banca — slide fixo logo após o objetivo.',
      },
      {
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        status: 'temos',
        onde: 'Declarado: "a Yamaha como a marca que responde em minutos e acompanha a moto a vida inteira (revisão → recompra)" — sustentado pela régua de revisões (R1–R4), Banco Yamaha (recompra na quitação) e SLA ≤10 min.',
        fazer: 'Falar a frase de posicionamento na banca e mostrar as 3 telas que a sustentam.',
      },
      {
      ...
      },
      {
        ...
        status: 'temos',
        onde: 'Tabulados na pesquisa Voz do Cliente (32 respostas): parcela 72% · atendimento rápido 66% · aprovação de crédito 56% · preço/entrada 47%. Cada fator ligado à tela que o atende. Tela /pesquisa.',
        fazer: 'Slide "fatores de compra medidos, não achados" com o gráfico da tela Voz do Cliente.',
      },
      {
        item: 'Os 7 passos foram claramente descritos',
        status: 'temos',
        onde: 'Mapeados (recepção → sondagem → apresentação → test-ride → negociação → fechamento → entrega/pós) com o ponto de atuação do Smart Dealer em cada passo — minuta neste dossiê, slide no deck da banca.',
        fazer: 'Apresentar o slide dos 7 passos e demonstrar 2 deles ao vivo (CRM na sondagem, régua na entrega/pós).',
      },
      {
        item: 'Pesquisas com clientes foram realizadas',
        status: 'temos',
        onde: 'Pesquisa Voz do Cliente: 32 respostas (18 compradores + 14 não compradores), satisfação 4,5/5, NPS 72, verbatims reais, motivos de não-compra (crédito recusado = 43%). Dashboards completos na tela /pesquisa.',
        fazer: 'Citar 2 falas de cliente na banca e mostrar o dashboard — pesquisa própria do projeto, não o NPS da Yamaha.',
      },
    ],
  },
  {
